...
It provides the microbial environment to kickstart the fermentation in your main dough.
...
\begin{figure}[!htb]
  ...
  I frequently use a stiff sourdough starter. The stiff starter features enhances yeast activity. In that case, you can
  use the same ratios as shown in the chart except for the water quantity. The stiff starter has a hydration of 50 to
  60 percent. So you would only use a tad more than half of the shown water quantities. I.e. if the chart shows 100g 
  of water, use 50 to 60g of water for your stiff starter.}
...
The second option at your disposal is adjusting the amount of starter
added to the main dough. As previously stated, your starter
...
reducing the starter works, I recommend option 1. It will reliably 
create better bread. Option 2 is typically what I use when I
fed my starter in the morning but didn't manage to make a dough
in the evening. I don't want to feed my starter again the next 
morning. I would like to make a dough directly without waiting
and thus use less of the very ripe starter.
